...
import type { Readable, RoutedHost } from '../../assets/js/shared/sections';

/**
 * ! Never calls back on listen, as the contract says and a nanostores atom does not: an atom here
 ...
 */
export function fakeHost(overrides: Partial<RoutedHost> = {}): RoutedHost {
  return {
    baseUrl: '/admin/tool/_/admin:extension/com.enonic.xp.app.users:users',
    extension: 'com.enonic.xp.app.users:users',
    locale: 'en',
